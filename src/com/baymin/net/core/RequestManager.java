 ...
 *  https://github.com/yakivmospan/volley-request-manager
 *
 */
public class RequestManager {
    ...
    public class RequestController {
        ...
        public RequestController addRequest(Request volleyRequest, Object tag) {
            volleyRequest.setTag(tag);
            mQueueBuilder.getRequestQueue().add(volleyRequest);
            return this;
        }
