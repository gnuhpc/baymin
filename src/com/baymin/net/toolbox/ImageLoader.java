...
import com.baymin.net.request.ImageRequest;
...
public class ImageLoader {
    ...
    public ImageContainer get(String requestUrl, ImageListener imageListener,
		...
		ImageRequest newRequest = createRequest(requestUrl, maxWidth, maxHeight);
	...
	protected ImageRequest createRequest(String requestUrl, int maxWidth, int maxHeight) {
